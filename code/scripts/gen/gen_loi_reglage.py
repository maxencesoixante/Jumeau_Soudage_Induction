...
ax.fill_between(COURANTS, tw, td, color="#B7E4C7", alpha=0.75,
                label="Fenêtre de soudage — point chaud 337 °C → seuil de pic 450 °C")
...
ax.plot(COURANTS, td, "-", color="#C1272D", lw=1.3,
        label="Borne haute — seuil de pic 450 °C (≡ dose 1 pour 20 s)")
