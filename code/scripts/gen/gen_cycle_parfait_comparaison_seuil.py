...
Données = gen_cycle_parfait_semistatique.py (modèle 2D, θ*, mode opératoire réel
serieA/B 4 spots) :  - Tg 159 °C : run par défaut ;  - 120 °C : SEUIL_REFROID=120.
130 A NE SOUDE PAS (P1 n'atteint jamais 390 °C dans les 300 s cappées).
...
TOTAL = {
    130: (1426.6, 1224.4, False),   # ne soude pas (P1 n'atteint jamais 390 °C)
