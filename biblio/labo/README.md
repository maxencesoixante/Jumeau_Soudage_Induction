...
| **Épaisseur — 3 TC empilés** | `donnees/data/epaisseur_3TC_2026-05/` | Gradient dans l'épaisseur au point (60, 20) : surface / interface / face opposée, à 174/201/226 A, plus une répétition à 226 A. Bobine fixe au centre, protocole antérieur au semi-statique. Le point 250 A de la même campagne est `donnees/data/chauffe_250A_3TC-epaisseur_2026-05-20.txt`. Le rapport opposée/interface, qui ancre la limite #2, passe d'une mesure unique (0,42) à une fourchette 0,32-0,48 dont l'amplitude est de la répétabilité. |
